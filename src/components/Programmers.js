...
export default function Programmers() {
  ...
  const [stateFeaturedProgrammer, set_stateFeaturedProgrammer] = useState(null);
  const [stateProgrammerList, set_stateProgrammerList] =
    useState(listOfAwesome);
  ...
  const getNameOfFeatured = () => {
    ...
    return stateFeaturedProgrammer
      ? stateProgrammerList[stateFeaturedProgrammer - 1].name
      : "";
  };
  ...
  const style = {
    fontSize: "1.5em",
    marginTop: "0.5em",
    color: stateFeaturedProgrammer ? "gold" : "royalblue",
            ...
            <div className="programmer" key={dev.id}>
              ...
              <button
                onClick={() => {
                  ...
                  set_stateFeaturedProgrammer(dev.id);
                }}
              >
                Feature
              </button>
